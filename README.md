...
## Conclusion 
This project analyzed the supply chain of a beauty startup in order to understand and synthesize potential bottlenecks in the four key phases of the supply chain. The analysis identified several bottlenecks throughout the supply chain, including supplier quality and reliability risks, haircare production bottleneck risk, inventory overstock and stockout concerns, and opportunities to improve shipping channels. Several recommendations were developed to improve supplier performance, improve production in the haircare segment, optimize inventory allocation, and streamline shipping pipelines. These findings help to provide insight to the business on opportunities to increase end-to-end supply chain reliability, reduce risk, optimize resource allocation, streamline processes, and improve overall supply chain performance. 
