--===================================================================================================================
--LOGISTICS (ROUTE) ANALYSIS QUERY
--Purpose: Creates clean data table of logistics KPIs for shipping route bottleneck analysis. 
--===================================================================================================================

SELECT  
routes, --Groups by 3 routes
COUNT(*) AS total_SKUs, --Counts total SKUs per route 
...
GROUP BY routes --Groups and sorts by shipping route